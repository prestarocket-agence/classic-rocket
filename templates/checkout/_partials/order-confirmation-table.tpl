 ...
 *}
<div id="order-items" class="c-panel c-panel--border">
    <div class="row u-mb-2">
        {block name='order_items_table_head'}
            <h3 class="table__title-head col-lg-6 col-12">{l s='Order items' d='Shop.Theme.Checkout'}</h3>
            <h3 class="table__title-head col-lg-2 u-d-desktop">{l s='Unit price' d='Shop.Theme.Checkout'}</h3>
            <h3 class="table__title-head col-lg-2 u-d-desktop">{l s='Quantity' d='Shop.Theme.Checkout'}</h3>
            <h3 class="table__title-head col-lg-2 u-d-desktop">{l s='Total products' d='Shop.Theme.Checkout'}</h3>
        {/block}
    </div>
        ...
        {block name='order_confirmation_table'}
            {foreach from=$products item=product}
                <div class="order-line row">
                    <div class="col-6 col-lg-2 u-mb-2">
                        <span class="image">
                    ...
                    <div class="col-lg-6 qty">
                        <div class="row">
                            <p class="col-6 u-h6 u-mb-2 u-d-mobile">{l s='Unit price' d='Shop.Theme.Checkout'}</p>
                            <div class="col-6 col-lg-4 text-sm-center text-left">{$product.price}</div>
                            <p class="col-6 u-h6 u-mb-2 u-d-mobile">{l s='Quantity' d='Shop.Theme.Checkout'}</p>
                            <div class="col-6 col-lg-4 text-sm-center">{$product.quantity}</div>
                            <p class="col-6 u-h6 u-mb-2 u-d-mobile">{l s='Total products' d='Shop.Theme.Checkout'}</p>
                            <div class="col-6 col-lg-4 text-sm-center text-right bold">{$product.total}</div>
                        </div>
                    </div>
                </div>
            {/foreach}
