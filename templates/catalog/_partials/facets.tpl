    ...
    <div id="search_filters">
        ...
        {foreach from=$displayedFacets item="facet"}
            <section class="facet clearfix">
                ...
                <div class="title visible-mobile" data-target="#facet_{$_expand_id}" data-toggle="collapse"{if !$_collapse} aria-expanded="true"{/if}>
              ...
              {include file='_partials/svg/chevron-up.svg'}
                ...
                {if in_array($facet.widgetType, ['radio', 'checkbox'])}
                    {block name='facet_item_other'}
                        ...
                        {else}
                          <span {if !$js_enabled} class="ps-shown-by-js" {/if}>{include file='_partials/svg/check2.svg'}</span>
                                                {/if}
                      </span>
                                        {else}
                ...
                {elseif $facet.widgetType == 'dropdown'}
                    {block name='facet_item_dropdown'}
                      ...
                      {/foreach}
                                        ...
                                        {include file='_partials/svg/caret-down-fill.svg'}
                                    </a>
