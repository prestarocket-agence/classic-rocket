  ...
  <div id="search_filters">
    ...
    {foreach from=$displayedFacets item="facet"}
      <section class="facet clearfix">
		...
		<div class="title" >
          <p class="h6 facet-title">{$facet.label}
			  <span class="float-xs-right">
				<span class="navbar-toggler icon-collapse" >
					<i class="material-icons add icon-collapse cursor-pointer float-right" data-target="#facet_{$_expand_id}" data-toggle="collapse"{if !$_collapse} aria-expanded="true"{/if}>&#xE313;</i>
				</span>
			  </span>
			 </p>
        </div>
